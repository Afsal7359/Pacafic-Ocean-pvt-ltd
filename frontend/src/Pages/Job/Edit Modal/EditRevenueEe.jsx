...
const EditRevenueEe = ({setModal,setCostData,setRevenueData,CostData,RevenueData,item,index,Data}) => {
    ...
    Data.RevenueData = [...updatedRevenueData]; 
      setModal(false);
    };
  return (
<>
