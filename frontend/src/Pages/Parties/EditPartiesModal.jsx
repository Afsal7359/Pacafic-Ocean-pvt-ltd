...
setIsloading(true)
    ...
    for (const key in data) {
      if (data[key] === true) {
        if (['Transporter', 'Sea Carrier', 'Customer', 'Airline', 'CHA', 'Others'].includes(key)) {
          if (key === 'Others') {
            if (data.OthersName) {
              ...
              <div className="col-sm-12">
                <div className="card">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    {['Transporter', 'Sea Carrier', 'Customer', 'Airline', 'CHA', 'Others'].map((label, index) => (
                    ...
                    {isOthersChecked && (
                      <div className="col-12 col-md-6 col-xl-6">
                        ...
                        <div className="form-group local-forms">
                          ...
                          <input type="file" style={{borderRadius:"10px",border:"3px solid #EEEEEE",width:"100%"}} {...register('GSTPhoto')} />
                        </div>
                      </div>
                      {/* <div className="col-12 col-md-6 col-xl-6">
                        <div className="form-group local-forms">
